/*
program three buttons to control Sonos
configure button1, button2, and button3
add correct IP of node server
keep port to 5005
add desired command like: /living room/volume/+3
*/
...
void setup() {
	...
	Serial.println(); // just to clear any garbage
